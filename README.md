...
Test to see if we can use [SDGmapper](https://knowsdgs.jrc.ec.europa.eu/sdgmapper) on Swedish documents using the [API](https://github.com/salgo60/SDGMapperSweden/issues/1)
